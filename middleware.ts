...
const DASHBOARD_PATHS = /^\/(overview|leads|clients|projects|proposals|assessments|deliverables|billing|requests|documents|settings|cleanup|prospects|visit|accounts)(\/|$)/
